<template>
  <div class="edit-sprint">
    <button type="button" class="btn btn-info btn-md falko-button" id="editIssue" data-toggle="modal" v-bind:data-target="`#editIssueModal${selected_issue.number}`" v-on:click="getIssuesInformation()">
      Editar Issue
    </button>
